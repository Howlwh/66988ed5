...
RegisterServerEvent("qpixel-inventory:exploiterKick")
onNet("qpixel-inventory:exploiterKick", async() => {
    ...
    //     {
    //         ["color"] = color,
    //         ["title"] = "** qpixel [Inventory] | Exploiter **",
    //         ["description"] = "Steam Name: "..source.." Was kicked for attempting to use an inventory exploit.",
    //     }
    // },
    // PerformHttpRequest("https://discord.com/api/webhooks/1012082797072097341/t8ELQWKi21GvBFrLhA2IQa9Tp6yHmO5IIHwzxItatPR5N2kV-Sk-DK0iPzZgGpOuPId8", function(color, title, headers){ end }, 'POST', json.encode({username = "qpixel | Exploiter Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] : 'application/json' })
});
...
function removecash(src, amount) {
    emit('qpixel-inventory:cash:remove', src, amount)
}
